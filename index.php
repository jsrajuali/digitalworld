...
<div class="elfsight-app-17f80b3f-3285-41f0-96cf-531534003eda"></div>
    <!-- Spinner Start -->
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light fixed-top shadow py-lg-0 px-4 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.php" class="navbar-brand d-block d-lg-none">
            <h1 class="text-primary fw-bold m-0">JSR Digital India</h1>
        </a>
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                <div class="col-lg-5 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h3 class="fw-bold">123 Street, New Delhi, India</h3>
                    <hr class="w-100">
                    <p class="mb-2">Call me:</p>
                    <h3 class="fw-bold">+91 (805) 7556 585</h3>
                    <hr class="w-100">
                    <p class="mb-2">Mail me:</p>
                    <h3 class="fw-bold">errajuali@gmail.com</h3>
                    <hr class="w-100">
